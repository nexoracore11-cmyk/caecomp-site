...
export const sampleData: PublicData = {
  settings: {
    sections: {
      ...
      directors: true, instagram: true, about: true, history: true, pretinha: true,
    },
  ...
  content: [
    { id: "n1", module: "news", title: "Um novo hub para a comunidade CAECOMP", slug: "novo-hub", summary: "Notícias, oportunidades, documentos e tudo que importa para a nossa comunidade agora vivem em um só lugar.", category: "Institucional", status: "published", imageUrl: "/caecomp-logo.jpg" },
    ...
    { id: "p1", module: "ca_products", title: "Camiseta oficial CAECOMP", slug: "camiseta-oficial", summary: "Identidade, tecnologia e orgulho de fazer parte da Engenharia de Computação.", status: "published", price: 59.9, stockMode: "limited", stockQty: 30, imageUrl: "/caecomp-logo.jpg" },

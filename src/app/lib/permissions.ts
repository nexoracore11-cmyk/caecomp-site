export const permissionOptions = [
  ...
  ["products","Diretoria de Produtos"], ["stores","Gerenciar a própria vendinha"], ["stores_manage","Cadastrar vendinhas e responsáveis"], ["stores_approve","Legado: aprovação de vendinhas"], ["news","Notícias"], ["documents","Documentos"],
